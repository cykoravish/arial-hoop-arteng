...
export function Contact() {
  ...
  const TELEGRAM_USERNAME = "aeriallyra_lux" // Replace with real username
  ...
  return (
    <section id="contact" className="py-28 md:py-36 px-6 bg-surface" aria-labelledby="contact-heading">
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
          {/* Left: info */}
          <div>
            <p className="font-body text-xs tracking-[0.3em] uppercase text-gold mb-6">{t.contact.label}</p>
            <h2
              id="contact-heading"
            ...
            <div className="flex flex-col gap-4">
              ...
              >
                {/* WhatsApp icon */}
                <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor" className="text-gold flex-shrink-0" aria-hidden="true">
          ...
          <div>
            {submitted ? (
              <div className="flex flex-col items-center justify-center h-full min-h-64 text-center py-16">
                ...
                <p className="font-display text-2xl text-foreground mb-3">{t.contact.form.successHeading}</p>
                <p className="font-body text-sm text-muted-foreground">{t.contact.form.success}</p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="flex flex-col gap-6" noValidate>
                ...
                {/* Event type */}
                <div className="flex flex-col gap-2">
                  <label htmlFor="eventType" className="font-body text-xs tracking-widest uppercase text-muted-foreground">
                ...
                {/* Date */}
                <div className="flex flex-col gap-2">
                  <label htmlFor="date" className="font-body text-xs tracking-widest uppercase text-muted-foreground">
                    {t.contact.form.date}
                  </label>
                  <input
                    id="date"
