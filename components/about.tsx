...
export function About() {
  ...
  return (
    <section
      id="about"
      className="pt-12 pb-20 md:py-36 px-6 bg-background"
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="relative order-2 md:order-1">
            <div className="relative h-[420px] md:h-auto md:aspect-[4/5] overflow-hidden">
              <Image
            ...
            {/* Stats overlay */}
            <div className="mt-6 bg-surface-raised border border-border p-4 flex justify-between">
              {stats.map((stat) => (
                <div key={stat.label} className="flex-1 text-center">
                  <p className="font-display text-2xl md:text-4xl font-light text-gold">
                    {stat.value}
                  </p>
                  <p className="font-body text-[10px] md:text-xs tracking-widest uppercase text-muted-foreground mt-1">
                    {stat.label}
                  </p>
                </div>
              ))}
          ...
          {/* Content side */}
          <div className="mt-0 md:mt-0 order-1 md:order-2">
            {/* Section label */}
