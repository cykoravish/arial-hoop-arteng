...
export const translations = {
  en: {
    ...
    about: {
      label: "About Me",
      heading: "Where Elegance Meets the Air",
      p1: "With over 12 years of experience in aerial arts, I bring a breathtaking combination of strength, grace, and artistry to every performance. Based in Luxembourg, I have dedicated the last 2 years to building my own performance business — crafting bespoke experiences that leave a lasting impression.",
      p2: "Specializing in bachelor parties and private celebrations, I transform ordinary gatherings into extraordinary memories. My shows are carefully tailored to each event, ensuring your guests experience something truly unique and unforgettable.",
      stat1Value: "12+",
    ...
    why: {
      label: "Why Choose Me",
      heading: "The Standard of Excellence",
      items: [
        {
    ...
    contact: {
      ...
      form: {
        ...
        success: "Thank you! I will be in touch within 24 hours.",
      },
  ...
  fr: {
    ...
    about: {
      label: "À Propos",
      heading: "Là où l'élégance rencontre l'air",
      p1: "Avec plus de 12 ans d'expérience dans les arts aériens, j'apporte une combinaison époustouflante de force, de grâce et d'art à chaque performance. Basée au Luxembourg, j'ai consacré ces 2 dernières années à développer ma propre entreprise de spectacles.",
      p2: "Spécialisée dans les enterrements de vie de jeune fille et les célébrations privées, je transforme les rassemblements ordinaires en souvenirs extraordinaires. Chaque spectacle est soigneusement adapté pour garantir une expérience unique et inoubliable.",
      stat1Value: "12+",
      stat1Label: "Ans d'Expérience",
      stat2Value: "200+",
      stat2Label: "Événements",
      stat3Value: "2",
    ...
    why: {
      ...
      heading: "Le Standard de l'Excellence",
      items: [
        {
    ...
    contact: {
      ...
      form: {
        ...
        success: "Merci ! Je vous contacterai dans les 24 heures.",
      },
  ...
  de: {
    ...
    about: {
      label: "Über Mich",
      heading: "Wo Eleganz die Luft trifft",
      p1: "Mit über 12 Jahren Erfahrung in der Luftakrobatik bringe ich eine atemberaubende Kombination aus Kraft, Anmut und Artistik in jede Aufführung. In Luxemburg ansässig, habe ich die letzten 2 Jahre damit verbracht, mein eigenes Aufführungsunternehmen aufzubauen.",
      p2: "Spezialisiert auf Junggesellinnenabschiede und private Feiern verwandle ich gewöhnliche Zusammenkünfte in außergewöhnliche Erinnerungen. Jede Show wird sorgfältig auf das jeweilige Event abgestimmt.",
      stat1Value: "12+",
    ...
    why: {
      label: "Warum Ich",
      heading: "Der Standard der Exzellenz",
      items: [
        {
    ...
    contact: {
      ...
      form: {
        ...
        success: "Vielen Dank! Ich melde mich innerhalb von 24 Stunden.",
      },
